...
public class CmdDiceTen implements Command, IDiced
{
	...
	public boolean called(String[] args, GuildMessageReceivedEvent e)
	{
		...
		if (args.length == 1)
		{
			...
			else
			{
				...
				writer.writeError("Please use the format -w10 [quantity] :weary:");
			}
		return isCalled;
	}
	...
	public void action(String[] args, GuildMessageReceivedEvent e)
	{
		...
		if (quant > 0)
		{
			...
			writer.writeSuccess(
			        e.getMember().getNickname() + " throws a 10 sided dice " + quant + " times and gets a " + res);
		}
		else
		{
			res = diceOnce(rn);
			writer.writeSuccess(e.getMember().getNickname() + " throws a 10 sided dice and gets a " + res);
		}
	...
	public void executed(boolean success, GuildMessageReceivedEvent event)
	{
		if (success)
		{
			System.out.println("Command -w10 was executed with success");
		}
		else
		{
			System.out.println("Command -w10 could not be executed successfully");
		}
		quant = 0;
		writer = null;
	}
